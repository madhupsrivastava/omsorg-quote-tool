...
const ADDON_PLANS = [
  { id: "coordination", name: "Remote Coordination Plan", price: 2900, period: "year", tag: "For families at a distance", features: ["Round-the-clock emergency coordination helpline", "Emergency ambulance & BLS support (up to twice a year)", "On-call doctor access during medical emergencies (up to twice a year)", "Fortnightly welfare calls from your dedicated Omsorg coordinator", "Comprehensive annual health screening (81-parameter panel) + teleconsultation review", "Referrals to our curated network of doctors & physiotherapists", "Senior group experiences, exclusive wellness events & milestone celebrations", "Dedicated care navigation support during hospital stays", "Help desk for value-added services"], relevant: ["all"] },
  { id: "health", name: "Health Management Plan", price: 1500, period: "month", tag: "Proactive wellness oversight", features: ["Weekly wellness check-in call from your coordinator", "Doctor teleconsultation once every 3 months", "Easy access to professional medical advice & guidance", "Doctor home visit once every 6 months", "Personalised geriatric care plan tailored to your loved one", "Regular health & fall risk assessments to ensure safety", "Annual full body health check-up with doctor recommendations", "Assistance with curating birthdays and special occasions", "Priority access to verified nurses & attendants", "Priority access to Omsorg Assisted Living Homes"], relevant: ["all"] },
  { id: "errands", name: "Errands Support Plan", price: 3200, period: "month", tag: "Practical day-to-day help", features: ["6 dedicated hours of at-home support each month", "Appointment accompaniment to hospitals, clinics and specialists", "Assistance with paying bills and managing day-to-day errands"], relevant: ["all"] },
  { id: "emotional", name: "Emotional Wellbeing Plan", price: 6700, period: "month", tag: "Mental health & companionship", features: ["Weekly companionship visits from a trained support companion", "Weekly wellness check-in call", "Monthly mental wellbeing assessment by a qualified doctor", "Regular monitoring & professional support for mental health", "Peer group access to share experiences and receive community support"], relevant: ["dementia", "palliative"] },
  { id: "caregiver", name: "Caregiver Support Plan", price: 550, period: "month", tag: "For the family carer", features: ["Annual full body check-up to monitor the caregiver's own health & wellbeing", "Doctor teleconsultation once every 3 months for personalised medical advice", "Peer support groups to connect and share with other caregivers", "Geriatric caregiving education materials to strengthen your caregiving skills"], relevant: ["all"] },
  { id: "diabetes", name: "Diabetes Management Plan", price: 2400, period: "month", tag: "Structured diabetes care", features: ["Daily monitoring calls by your Omsorg Care Coordinator — education, appointments, medicines & tests", "Quarterly HbA1c blood tests with teleconsultation review and diabetic complication assessments", "Thorough health monitoring by our expert doctors", "Weekly dietician teleconsultation sessions for personalised dietary advice", "Diabetes peer support groups for shared experiences and insights", "Priority access to top eye specialists for regular eye health reviews", "Online lifestyle sessions covering yoga, meditation and living with diabetes", "Medicine ordering reminders and home delivery coordination", "Access to essential disease education materials", "Assistance with ordering blood glucose monitoring devices (CGMS, Accu-Chek, glucometer strips) at discounted rates"], relevant: ["diabetes"] },
  { id: "dementia", name: "Dementia Management Plan", price: 8100, period: "month", tag: "Specialist dementia support", features: ["Weekly monitoring calls by your Omsorg Care Coordinator for wellbeing, appointments and medicines", "Monthly doctor teleconsultations for medical oversight", "Psychologist teleconsultation sessions every 3 months with regular mental wellbeing assessments", "Caregiver counselling on managing difficult behaviours and online support groups", "Annual full body health screening", "Dietician session every 3 months for nutritional guidance", "One complimentary physiotherapy session", "6 hours monthly appointment accompaniment support", "Priority access to full-time or part-time nursing & caregiver respite support", "Medicine ordering reminders and delivery coordination"], relevant: ["dementia"] },
  { id: "ckd", name: "Chronic Kidney Disease Plan", price: 7900, period: "month", tag: "Kidney health management", features: ["Weekly coordinator calls — CKD education, appointments, medicines, tests and dialysis centre transport", "Monthly doctor teleconsultations for medical guidance", "Monthly psychologist teleconsultation sessions for emotional support", "Annual full body screening with specialised renal packages (eGFR, BUN, ACR etc.)", "One complimentary physiotherapy session", "6 hours monthly appointment accompaniment (including dialysis visits)", "Priority access to full-time or part-time nursing & caregiver support", "Medicine ordering reminders and delivery coordination", "Peer support groups for shared experiences and advice", "Access to essential disease education materials"], relevant: ["catheter", "oxygen"] },
  { id: "stroke", name: "Stroke Recovery Plan", price: 9900, period: "month", tag: "Post-stroke rehabilitation support", features: ["Weekly coordinator calls — post-stroke education, appointments, medicines and transport support", "Monthly doctor teleconsultations for medical guidance", "Monthly psychologist teleconsultation sessions", "One complimentary physiotherapy session", "6 hours monthly appointment accompaniment", "Dietician session every 3 months for recovery nutrition guidance", "Priority access to full-time or part-time nursing & caregiver support", "Medicine ordering reminders and delivery coordination", "Regular home safety assessments", "Access to essential disease education materials", "Peer support groups for shared experiences and advice"], relevant: ["bedridden", "transfer"] },
  { id: "arthritis", name: "Arthritis Management Plan", price: 4600, period: "month", tag: "Joint health & mobility", features: ["Weekly coordinator calls — arthritis education, appointments, medicines and transport support", "Monthly doctor teleconsultations for medical guidance", "One complimentary physiotherapy session", "Dietician session every 3 months for joint-health nutrition guidance", "Monthly pain management advisory support", "Priority access to full-time or part-time nursing & caregiver support", "Medicine ordering reminders and delivery coordination", "Regular home safety assessments", "Peer support groups for shared experiences and advice", "Access to essential disease education materials"], relevant: ["transfer"] },
  { id: "heart", name: "Heart Disease Management Plan", price: 6300, period: "month", tag: "Cardiac health monitoring", features: ["Weekly coordinator calls — cardiac education, appointments, medicines and transport support", "Monthly doctor teleconsultations for medical guidance", "One complimentary physiotherapy session", "Dietician session every 3 months for heart-healthy nutrition", "Priority access to full-time or part-time nursing & caregiver support", "Medicine ordering reminders and delivery coordination", "Regular home safety assessments", "Peer support groups for shared experiences and advice", "Access to essential disease education materials"], relevant: ["oxygen"] },
  { id: "cancer", name: "Cancer Management Plan", price: 14200, period: "month", tag: "Comprehensive oncology support", features: ["Weekly coordinator calls — cancer education, appointments, medicines and transport support", "Monthly doctor teleconsultations for medical guidance", "One complimentary physiotherapy session", "Monthly dietician sessions tailored to cancer nutrition needs", "Monthly psychologist teleconsultation sessions", "6 hours monthly appointment accompaniment for treatments", "Monthly pain management advisory support", "Guidance on pharma patient assistance programmes for reduced medication costs", "Priority access to full-time or part-time nursing & caregiver support", "Medicine ordering reminders and delivery coordination", "Regular home safety assessments", "Peer support groups for shared experiences and advice", "Access to essential disease education materials"], relevant: ["palliative"] },
];
